...
#define AI_NETWORK_MODEL_SIGNATURE     "0x72d4c8c60b8939d8ebd9aa38ea2f0b24"
...
#define AI_TOOLS_DATE_TIME   "2026-03-15T12:42:19+0800"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 1, 15), AI_STRIDE_INIT(4, 4, 4, 128, 128),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  3, 0x0,
  AI_SHAPE_INIT(4, 64, 1, 3, 32), AI_STRIDE_INIT(4, 4, 256, 8192, 8192),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  19, 0x0,
  AI_SHAPE_INIT(4, 1, 6, 1, 30), AI_STRIDE_INIT(4, 4, 4, 24, 24),
...
AI_LAYER_OBJ_DECLARE(
  global_average_pooling1d_pool_layer, 3,
  POOL_TYPE, 0x0, NULL,
  pool, forward_ap,
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 39316, 1, 1),
    39316, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 5144, 1, 1),
    5144, NULL, NULL),
  ...
  &conv1d_conv2d_layer, 0xf795258e, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    conv1d_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 720);
    conv1d_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 720);
    conv1d_conv2d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 792);
    conv1d_conv2d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 792);
    conv1d_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 1304);
    conv1d_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1304);
    ...
    conv1d_1_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 920);
    conv1d_1_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 920);
    conv1d_1_output_array.data = AI_PTR(g_network_activations_map[0] + 2840);
    conv1d_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2840);
    ...
    dense_output_array.data = AI_PTR(g_network_activations_map[0] + 384);
    dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 384);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv1d_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 4608);
    conv1d_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 4608);
    conv1d_1_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_1_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 4864);
    conv1d_1_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 4864);
    conv1d_1_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_1_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 29440);
    conv1d_1_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 29440);
    ...
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 37760);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 37760);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 38016);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 38016);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 39296);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 39296);
    return true;
  }
